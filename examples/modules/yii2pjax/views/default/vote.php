...
$this->title = 'Yii2 и Pjax: Пример с отключением pushState';
...
<?= Html::a('', ['/yii2pjax/upvote'], ['class' => 'btn btn-lg btn-warning glyphicon glyphicon-arrow-up']) ?>
<?= Html::a('', ['/yii2pjax/downvote'], ['class' => 'btn btn-lg btn-primary glyphicon glyphicon-arrow-down']) ?>
