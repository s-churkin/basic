...
$this->title = 'Yii2 и Pjax: Пример с отправкой формы';
...
<div class="site-index">
    ...
    <?php Pjax::begin(); ?>
    <?= Html::beginForm(['/yii2pjax/form-submission'], 'post', ['data-pjax' => '', 'class' => 'form-inline']); ?>
    ...
    <hr />
    <p>Представление views\site\form-submission.php:<br>
...
&lt;?= <span style="color:#33f;font-weight:700">Html</span><span style="color:#00f">::</span>beginForm([<span style="color:#093">'site/form-submission'</span>], <span style="color:#093">'post'</span>, [<span style="color:#093">'data-pjax'</span> <span style="color:#00f">=></span> <span style="color:#093">''</span>, <span style="color:#093">'class'</span> <span style="color:#00f">=></span> <span style="color:#093">'form-inline'</span>]); ?>
    ...
    &lt;?= <span style="color:#33f;font-weight:700">Html</span><span style="color:#00f">::</span>submitButton(<span style="color:#093">'Получить хеш'</span>, [<span style="color:#093">'class'</span> <span style="color:#00f">=></span> <span style="color:#093">'btn btn-lg btn-primary'</span>, <span style="color:#093">'name'</span> <span style="color:#00f">=></span> <span style="color:#093">'hash-button'</span>]) ?>
